...
class SettlementReport extends HyperPay implements SettlementReportInterface
{
    ...
    {
        return response()->json($this->initiateReport());
    }
     ...
     * @throws Exception
     */
    private function initiateReport(): array
    {
        return $this->response( $this->SettlementReport() );
    }
        ...
        return [
            ...
            'config' => [
                ...
                'status' => [
                    ...
                    'message' => $this->validateStatus($response['result']['code'])? 'transaction success' : 'transaction declined'
                ]
            ]
        ];
    }
